...
vec4 transmittance(vec3 ori, vec3 end, float scale)
{
    ...
    t = vec4(exp(-(extictionOzone.r + extictionMie.r + extictionRayleigh.r)),
             exp(-(extictionOzone.g + extictionMie.g + extictionRayleigh.g)),
             exp(-(extictionOzone.b + extictionMie.b + extictionRayleigh.b)),
             1.0f);
